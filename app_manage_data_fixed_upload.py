...
uploaded_file = st.file_uploader("📥 الرجاء رفع ملف قالب بيانات التوزيع", type=["xlsx"])
if not uploaded_file:
    st.warning("⚠️ الرجاء رفع ملف Excel يحتوي على بيانات المشرفين والمدارس بصيغة القالب.")
    st.stop()
